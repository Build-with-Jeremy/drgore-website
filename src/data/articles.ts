...
export interface ArticleSection {
  type: "paragraph" | "heading" | "subheading" | "list" | "quote" | "note" | "comparison" | "numbered-list" | "footnote" | "link" | "image";
  text?: string;
  href?: string;
  items?: string[];
  start?: number;
...
export const articles: Article[] = [
  {
    slug: "what-nobody-will-tell-you-about-early-recovery",
    title: "What Nobody Will Tell You About Early Recovery and Going to Meetings.  And Why You Should Stay Clean and Sober Anyway",
    date: "September 11, 2026",
    summary: "The things that actually happen to your body, your moods and your friendships when you get clean, and the things about meetings that nobody warns you about first.",
    thumbnail: "/assets/articles/early-recovery-thumb.jpg",
    content: [
      { type: "list", items: [
        "Your body is going to go through changes",
        "You might gain weight",
        "You might have trouble sleeping",
        "You might be really clumsy",
        "You might forget things...like all the time",
        "Your emotions are going to be all over the place",
        "You might need to go on medication - temporarily or for a while.",
        "You’re going to crave sugar",
        "You will have cravings to use/drink",
        "You might feel lost and/or depressed",
        "You might have drunk/high dreams",
        "Your family and friends might not like it so much that you’re sober/clean",
        "You may be bored",
        "Meetings may not be enough",
        "People might swarm you at your first couple of meetings",
        "People are going to ask you why you’re not drinking",
        "You’re going to be in situations where people are drinking, and might even pressure you to do so",
        "People may annoy you by sharing too long",
        "Your doctor(s) may know less about addiction than you do",
        "You might feel like the sickest person in the room and want to run",
        "You might feel like the healthiest person in the room and want to run",
        "You might not understand what the hell some people are talking about when they share",
        "If you are a woman, the men may feel creepy",
        "You might not know why people are laughing",
        "People who are on a pink cloud will annoy you",
        "People who are miserable and share for a long time will annoy you",
        "It might feel like a cult",
        "Sobriety will often suck",
        "The god stuff is weird if you find god stuff weird",
        "You will romance the “good old days”",
        "There will be cliques and you may not be in one",
      ] },
    ],
  },
  {
    slug: "jumpstart-your-coupleship",
    title: "Jumpstart Your Coupleship: 36 Questions to Reconnect With Your Partner",
    date: "September 11, 2026",
    summary: "Thirty-six questions to take turns asking each other on a car ride, a park bench, or a walk. Unplug, and really listen to your partner.",
    thumbnail: "/assets/articles/couple-questions-thumb.jpg",
    content: [
      { type: "paragraph", text: "I found these questions years ago, but I lost who should be attributed as author.   Not me.   But, these questions are a great way to re-connect with your partner.  Car rides?  Hanging out on a park bench?  Just taking a walk together?  Unplug, take turns asking each other questions, and listen, really listen to your partner." },
      { type: "heading", text: "Set I" },
      { type: "numbered-list", start: 1, items: [
      ...
      { type: "heading", text: "Set III" },
      { type: "numbered-list", start: 25, items: [
  ...
  {
    slug: "jumpstart-knowing-your-kid-better",
    title: "Jumpstart Knowing Your Kid Better: Conversation Starters for Parents",
    date: "September 11, 2026",
    summary: "Prompts to get your kids talking, for when \"How was your day?\" keeps coming back \"Fine.\" Be a good, active listener.",
    thumbnail: "/assets/articles/conversation-starters-thumb.jpg",
    content: [
      { type: "paragraph", text: "How was your day?   Fine" },
      { type: "paragraph", text: "Here are some “prompts” to get your kids talking.  Be a good, active listener.  And don’t be surprised if your child asks you for your best answers to some of these." },
      { type: "list", items: [
        "Who is your best friend?   Why is he/she your best friend?",
        "Describe a perfect day?  A perfect evening?",
        "What is the best thing about being ___ years old?  What stinks about being ___ years old?",
        "If you could be any cartoon character, who would it be?",
        "What is the best movie ever?",
        "What is the one thing you couldn’t live without?",
        "If you could change one thing about yourself, what would it be?",
        "If you could change one thing about me, what would it be?",
        "What are you most afraid of?  What did you used to be afraid of, but aren’t anymore?",
        "If you could change the world, what would you make different?",
        "What is the best lunch/dinner/breakfast you ever had?",
        "Where do you want to go, just you and me?  How about when you get bigger, where do you want to go with me?  Or where would you go alone?",
      ] },
    ],
  },
  {
    ...
    title: "Giving a f@#k",
    date: "September 11, 2026",
    summary: "One chart from Dr. Gore: how much we give a f@#k, plotted against age.",
    thumbnail: "/assets/articles/giving-a-f-k-thumb.jpg",
    content: [
      { type: "image", text: "Line chart. The vertical axis is labelled GIVING-A-F@#K and the horizontal axis is labelled Age. The line climbs steeply in youth, peaks early, then falls away steadily to zero and stays there.", href: "/assets/articles/giving-a-f-k-chart.svg" },
    ],
  },
  {
    slug: "are-families-important",
    title: "Are Families Important?  And Who Do You Want to Work on Yours?",
    date: "September 11, 2026",
    summary: "Dr. Gore on why he thinks about the whole family even when only one person is in the room, and why a Family Therapist who is also a Clinical Psychologist is still hard to find.",
    thumbnail: "/assets/articles/family-therapy-thumb.jpg",
    content: [
      { type: "paragraph", text: "When I went to graduate school last century, there were only a couple of PhD programs in Clinical Psychology with a Family Therapy specialty. Now there are hundreds of Family Therapy programs; in Georgia, there is even a master’s degree level Licensure for this. It's still unusual to find someone who is both a Family Therapist and a Clinical Psychologist." },
      { type: "paragraph", text: "I've been working with families since 1983, and my family therapy skills are sharp. Like a knife — a well-honed one. You're getting this metaphor, aren't you?" },
      { type: "paragraph", text: "I believe in family therapy whole-heartedly: for child issues, marital and couple issues, adolescent issues, even individual issues. When I work with adult clients, I'm thinking about their entire family, even when it's just the client and me in the room. Families shape us, and families keep us stuck. I can help you get unstuck from disruptive family patterns." },
      { type: "paragraph", text: "Working with whole families requires thinking differently. I know how a family works, how generational patterns repeat, how hard it is to change the way people talk to each other. But when a family's emotions shift, each person blossoms. Let me help you get unstuck and moving in a good direction." },
    ],
  },
  {
    slug: "signs-of-a-healthy-family-system",
    title: "Signs of a Healthy Family",
    date: "September 11, 2026",
    summary: "Most people think a healthy family is one that does not fight. Dr. Gore on what actually separates a healthy family system from a dysfunctional one.",
    thumbnail: "/assets/articles/healthy-family-system-thumb.jpg",
    content: [
      { type: "subheading", text: "(Hint: Nobody Said “No Fighting”)" },
      { type: "paragraph", text: "Most people think a healthy family is one that doesn't fight." },
      { type: "paragraph", text: "Wrong." },
      { type: "paragraph", text: "Healthy families have real disagreements. If yours doesn't, that may not be peace — it may be everybody keeping their mouths shut and calling it harmony." },
      { type: "paragraph", text: "I've spent 42 years watching families come apart and put themselves back together. The ones that work don't look like the families on TV. They argue. They get hurt. They don't always handle it well. But they find their way back to each other." },
      { type: "paragraph", text: "Here's what actually separates a healthy family system from a dysfunctional one, adapted from a framework I've used for years in my practice." },
      { type: "heading", text: "Conflict Has a Shape" },
      { type: "paragraph", text: "A fight in a healthy family has a beginning, a middle, and an end." },
      { type: "paragraph", text: "It starts. It gets loud or uncomfortable. And then — this is the part many families skip — it actually ends." },
      { type: "paragraph", text: "Nobody is still bringing it up three Thanksgivings later." },
      { type: "paragraph", text: "Healthy families negotiate without put-downs. Every member can say yes or no without being punished for it, mocked for it, or frozen out for it." },
      { type: "paragraph", text: "That's not a minor detail." },
      { type: "paragraph", text: "That's most of the job." },
      { type: "paragraph", text: "Differences of opinion aren't treated as betrayal. Somebody can vote differently, dress differently, think differently, or make different choices — and it doesn't become a referendum on whether they're still loved." },
      { type: "heading", text: "Straight Talk, Not Sarcasm" },
      { type: "paragraph", text: "Feelings get said out loud in healthy families." },
      { type: "paragraph", text: "Not vented sideways through sarcasm. Not stuffed until they leak out as a stomachache or a slammed door three days later." },
      { type: "paragraph", text: "Said. Directly. To the person they're about." },
      { type: "paragraph", text: "That includes the negative ones." },
      { type: "paragraph", text: "A family member can be angry, disappointed, or hurt and say so without threatening whether the relationship survives." },
      { type: "paragraph", text: "If every strong feeling has to be hidden to keep the peace, that's not peace." },
      { type: "paragraph", text: "That's a hostage negotiation." },
      { type: "heading", text: "Everybody Gets to Be a Person" },
      { type: "paragraph", text: "This is the one most families get wrong without noticing." },
      { type: "paragraph", text: "Healthy families let individual members have individual relationships. A kid can be closer to one parent. A sibling pair can have their own thing. A parent can have a friendship that doesn't involve the rest of the family." },
      { type: "paragraph", text: "Nobody treats that as disloyalty to the group." },
      { type: "paragraph", text: "Healthy families also make room for growth." },
      { type: "paragraph", text: "If a family member changes — gets sober, gets ambitious, changes careers, gets therapy, finds a new interest, or simply starts becoming more of the person they want to be — the healthy response is:  “Good for you.”" },
      { type: "paragraph", text: "Not:  “Who do you think you are?”" },
      { type: "paragraph", text: "Growth doesn't have to be a threat to the family." },
      { type: "heading", text: "Presence, Not Just Proximity" },
      { type: "paragraph", text: "Being in the same house isn't the same as being there for each other." },
      { type: "paragraph", text: "Healthy families show up for the big stuff — crisis, celebration, graduations, funerals." },
      { type: "paragraph", text: "But they also show up for the boring stuff." },
      { type: "paragraph", text: "The Tuesday-night dinner." },
      { type: "paragraph", text: "The forgettable Wednesday." },
      { type: "paragraph", text: "The ordinary Saturday morning." },
      { type: "paragraph", text: "Most of family life is Wednesdays." },
      { type: "paragraph", text: "Healthy families spend actual time, money, and energy having fun together." },
      { type: "paragraph", text: "And — this one surprises people — they protect individual time, too." },
      { type: "paragraph", text: "Everybody gets some time alone. Parents get time with each other, separate from the kids, and treat that marriage or partnership as something worth maintaining on its own." },
      { type: "paragraph", text: "Being a family doesn't mean doing everything together." },
      { type: "heading", text: "How the Family Handles a Bad Week" },
      { type: "paragraph", text: "Stress hits every family." },
      { type: "paragraph", text: "The healthy ones respond with flexibility. They look for options. They adjust. And, critically, they ask for outside help when they need it." },
      { type: "paragraph", text: "Asking for help isn't a failure state.  It's the system working correctly." },
      { type: "paragraph", text: "You can also see the cost of chronic family stress in people's bodies — sleep problems, stomachaches, headaches, tension, exhaustion." },
      { type: "paragraph", text: "That doesn't mean every physical symptom comes from the family. It means that living with unresolved tension has a cost, and sometimes the body makes that cost harder to ignore." },
      { type: "heading", text: "The Bottom Line" },
      { type: "paragraph", text: "A healthy family isn't one without problems." },
      { type: "paragraph", text: "It's one where the identity underneath everything is:" },
      { type: "paragraph", text: "I count, and we count." },
      { type: "paragraph", text: "Where trust in the relationship is strong enough to survive an honest conversation, a bad week, a difference of opinion, or somebody changing." },
      { type: "paragraph", text: "If you read this and mostly nodded, that's a good sign." },
      { type: "paragraph", text: "If you read it and thought, We don't do much of that, that's useful information too." },
      { type: "paragraph", text: "And if you found yourself getting angry at something you read here, pay attention to that." },
      { type: "paragraph", text: "Sometimes the thing we most want to argue with is the thing worth looking at." },
      { type: "paragraph", text: "That's what I'm here for." },
      { type: "link", text: "Schedule a Consultation", href: "/contact" },
    ],
  },
  {
