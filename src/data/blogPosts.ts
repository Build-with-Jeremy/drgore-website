...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "A Message For Dads",
    date: "September 11, 2026",
    summary: "Dr. Gore on a passage from Bruce Springsteen's autobiography, what his wife said to him one day at noon, and why the mornings are the ones you do not get back.",
    thumbnail: "/assets/blog/make-the-pancakes.jpg",
    content: [
      "Read this, please.  It is from Bruce Springsteen’s autobiography Born to Run.  I will wait…",
      ...
      "No mother who is the primary wage earner sleeps through breakfast every day and gets a pass for it. Bruce Springsteen did — until his wife stopped letting him.",
      "He listened. She was right: kids need us differently in the morning than at any other hour, and if you're not there, you don't get it back.",
      "I've never played a song for 80,000 screaming fans. But I've made breakfast for my kids and felt the same thing — applause, gratitude, the room being all connected. The food was never the point. It was the excuse to be in the room for the conversation.",
    ],
  },
  {
