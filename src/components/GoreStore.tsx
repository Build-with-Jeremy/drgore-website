...
const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Is your wife over-committed with her volunteering? Just sprinkle these Stop Volunteering Flakes in her morning coffee and watch her learn to say "no."',
  },
  {
  ...
  },
  {
    ...
    description: "He's 34, plays video games all night and sleeps all day. He can't get a job because nobody has driven over to your house and offered him a position worthy of his talents. He doesn't pay rent, or clean up after himself. Time for the Fogger.",
  },
  {
    ...
    <div>
      ...
      {toast && (
        <div
          ...
          role="alert"
        >
          <p className="font-semibold text-sm mb-0.5">Nice try! 😄</p>
          <p className="text-xs opacity-80 line-clamp-2">"{toast}" is not a real product. But we appreciate your sense of humor!</p>
        </div>
      )}
